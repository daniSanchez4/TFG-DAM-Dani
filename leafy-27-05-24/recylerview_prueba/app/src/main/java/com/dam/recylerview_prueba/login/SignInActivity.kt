...
class SignInActivity : AppCompatActivity(), Animaciones {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animateViewWithSlideUp(binding.inicio, 1000)
        animateViewWithSlideUp(binding.porfavor, 1300)
        animateView(binding.emailEt)
        animateView(binding.passET)
        animateView(binding.forgotPW)
        animateView(binding.textView)
        animateView(binding.button)
        animateViewWithSlideUp(binding.logo, 1000)
        animateView(binding.rememberMeChkb)
